  ...
  return (
    <div className="bg-white dark:bg-[#212121] text-black dark:text-slate-200 w-full h-full min-h-[297mm] p-[40px] md:p-[50px] flex flex-col font-sans">
      ...
      <header className="mb-6">
        ...
        <h2 className="text-lg font-normal text-gray-600 dark:text-slate-400 tracking-wide mb-4">{data.profile.role}</h2>
        <div className="border-b-2 border-black dark:border-white"></div>
      </header>

      {/* Experience section with separator at the end */}
      <section className="mb-6">
        <h3 className="text-xl font-bold uppercase mb-4 text-black dark:text-white">{getSectionTitle('experience')}</h3>
        ...
        <div className="border-b border-black dark:border-slate-600 mt-6"></div>
      </section>

      {/* Education section with separator at the end */}
      <section className="mb-6">
        <h3 className="text-xl font-bold uppercase mb-4 text-black dark:text-white">{getSectionTitle('education')}</h3>
      ...
      <section className="mt-auto">
        <h3 className="text-xl font-bold uppercase mb-4 text-black dark:text-white">{getSectionTitle('contact')}</h3>
        <ul className="text-[13px] text-black dark:text-slate-300 space-y-1 list-disc list-outside ml-4">
          <li>
